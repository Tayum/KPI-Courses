...
namespace OOP_Lab1_Gonchar_Maxim_KP51
{
    ...
    public class Hero : Model, IFightable, IDestructable
    {
        ...
        /// </summary>
        protected List<GameItem> backpack;
        ...
        {
            Logger.printMsgGame("This Hero died bravely.");
        }
        ...
        {
            Logger.printMsgPlayer("I am dying, help me!");
        }

        /// <summary>
        /// <para>Delete Hero instance from the map.</para>
        /// </summary>
        public virtual void deleteFromMap()
        {
            Logger.printMsgSystem(String.Format("Hero {0} instance has been deleted form the map.", this.Name));
        }
        ...
        {
            return String.Format("Hero {0}. Level {1}. Has {2} items in backpack. Sword: {3}. Created at {4}.", this.Name, this.level, this.backpack.Count, this.sword, this.lifeTime);
        }
    }
}
