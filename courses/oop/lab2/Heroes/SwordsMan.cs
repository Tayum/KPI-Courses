...
namespace OOP_Lab1_Gonchar_Maxim_KP51
{
    ...
    public class SwordsMan : Hero
    {
        ...
        public override void die()
        {
            ...
            Logger.printMsgGame(String.Format("The swordsman {0} died.", this.Name));
        }
        ...
        public override void beforeDie()
        {
            ...
            Logger.printMsgGame(String.Format("Help me! I, {0} am about to die here!", this.Name));
        }
        ...
        public override void deleteFromMap()
        {
            ...
            Logger.printMsgSystem(String.Format("Swordsman {0} has been deleted from the map.", this.Name));
        }
        ...
        {
            return String.Format("Hero {0}. Level {1}. Has {2} items in backpack. Sword: {3}. Critical damage: {4:.2}.", this.Name, this.level, this.backpack.Count, this.sword, this.criticalChance);
        }
    }
}
